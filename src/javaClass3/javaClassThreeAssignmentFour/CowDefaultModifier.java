// Make One package and Two/three Class and make object for one class and  use access modifrer (property -- public/defaule/private with main method and object must.) in making class and run the program.


package javaClass3.javaClassThreeAssignmentFour;

// Default: One packages, A general class & another class main method and creating object. rules is :
// Package and inside all class can access (same package and all class can access). // 1+2.
// Here Cow Class is Default Class.


// General Class
 class CowDefaultModifier {
    // properties
